        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    lenguage_id = table.Column<byte>(type: "tinyint", nullable: false),
                    original_lenguage_id = table.Column<byte>(type: "tinyint", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_film", x => x.film_id);
                    table.ForeignKey(
                        name: "FK_film_language_lenguage_id",
                        column: x => x.lenguage_id,
                        principalTable: "language",
                        principalColumn: "language_id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_film_language_original_lenguage_id",
                        column: x => x.original_lenguage_id,
                        principalTable: "language",
                        principalColumn: "language_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_film_lenguage_id",
                table: "film",
                column: "lenguage_id");

            migrationBuilder.CreateIndex(
                name: "IX_film_original_lenguage_id",
                table: "film",
                column: "original_lenguage_id");
